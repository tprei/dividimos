-- Fix record_and_settle to require accepted group membership.
-- Previously used my_group_ids() which includes invited-but-not-accepted members,
-- allowing them to create settlements before accepting the group invitation.
