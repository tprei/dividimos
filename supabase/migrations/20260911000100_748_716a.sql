-- 716a: bind onboarding completion to the verified server identity.

set check_function_bodies = off;

CREATE OR REPLACE FUNCTION public.complete_onboarding(p_handle text, p_name text, p_pix_key_encrypted text, p_pix_key_hint text, p_pix_key_type public.pix_key_type)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
