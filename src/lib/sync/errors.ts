...
const MESSAGES: Record<LedgerErrorCode, string> = {
  ...
  guest_link_replacement_limit: "Este link já foi substituído uma vez.",
  ...
  invalid_notification_preferences: "Não foi possível salvar suas preferências de notificação.",
