...
export function GroupDetailContent({ initialData }: { initialData: GroupDetailData }) {
  const { groupId: id } = initialData;
  ...
  const [unclaimedGuests, setUnclaimedGuests] = useState(initialData.unclaimedGuests);
