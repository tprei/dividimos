...
const TEST_USERS: User[] = [
  ...
  { id: "test_julia", email: "julia@test.com", handle: "julia.santos", name: "Julia Santos", pixKeyType: "email", pixKeyHint: "j****a@test.com", onboarded: true, createdAt: new Date().toISOString() },
